object Dmod2: TDmod2
  ...
  object ObjectS: TDataSource
    DataSet = ObjectT
    OnStateChange = ObjectSStateChange
    Left = 416
    Top = 128
  end
  object StationS: TDataSource
    DataSet = StationT
    OnStateChange = StationSStateChange
    Left = 560
    Top = 128
  end
  object StationT: TADOTable
    Connection = Dmod1.ADOConnection1
    CursorType = ctStatic
    TableName = 'Station'
    Left = 560
  ...
  object StationChangeT: TADOTable
    Connection = Dmod1.ADOConnection1
    CursorType = ctStatic
    TableName = 'StationChange'
    Left = 624
    Top = 72
  end
  object StationChangeS: TDataSource
    DataSet = StationChangeT
    OnStateChange = ObjectSStateChange
    Left = 624
    Top = 128
  end
  object FaktHeadT: TADOTable
    Connection = Dmod1.ADOConnection1
    CursorType = ctStatic
    TableName = 'FAKTHEAD'
    Left = 32
  ...
  object EDIBaseS: TDataSource
    DataSet = EDIBaseT
    OnStateChange = EDIBaseSStateChange
    Left = 616
    Top = 248
  end
  object EDIBaseT: TADOTable
    Connection = Dmod1.ADOConnection1
    CursorType = ctStatic
    TableName = 'EDIBASE'
    Left = 616
  ...
  object EDICustS: TDataSource
    DataSet = EDICustT
    OnStateChange = EDICustSStateChange
    Left = 688
    Top = 248
  end
  object EDICustT: TADOTable
    Connection = Dmod1.ADOConnection1
    CursorType = ctStatic
    IndexFieldNames = 'Cust_Id'
    MasterFields = 'Cust_Id'
    MasterSource = CustomerS
    TableName = 'EDICUST'
    Left = 688
    Top = 200
  end
