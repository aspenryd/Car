...
begin
    ...
    begin
      ...
      if ComboBox2.ItemIndex = 2 then
        eqprn.PrintRegDatAvt(edit1.text, VisibleDateToStr(DateTimePicker1.Date), 1, cbgranska.checked);
    end;
...
//        dmcrystal.PrintKvitto(0, strtoint(edit1.text), 1, cbgranska.checked);
      ...
      if Combobox2.itemindex = 2 then
        eqprn.PrintRegDatKvi(Edit1.Text, VisibleDateToStr(DateTimePicker1.Date), 1, cbgranska.checked);
    end;
