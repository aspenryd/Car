...
{
{   Rev 1.0    2004-01-29 09:25:42  peter
...
type
  TfrmGReg = class(TForm)
    ...
    ObjectsTReg_No: TWideStringField;
    ObjectsTObjNum: TSmallintField;
    ObjectsTModel: TWideStringField;
    ObjectsTType: TWideStringField;
    ObjectsTKM_N: TIntegerField;
    ObjectsTKM_Service: TIntegerField;
    ObjectsTN_Service: TIntegerField;
    ObjectsTOut_KM: TIntegerField;
    ObjectsTTvolym: TSmallintField;
    ObjectsTDrvm_km: TFloatField;
    ObjectsTDType: TWideStringField;
    ObjectsTColor: TWideStringField;
    ObjectsTAccesories: TWideStringField;
    ObjectsTPriceClass: TWideStringField;
    ObjectsTStatus: TFloatField;
    ObjectsTKNOT1: TWideStringField;
    ObjectsTKNOT2: TWideStringField;
    ObjectsTNOTE: TMemoField;
    ObjectsTSRiskKonto: TIntegerField;
    ObjectsTHyrKonto: TIntegerField;
    ObjectsTKmKonto: TIntegerField;
    ObjectsTXHyrKonto: TIntegerField;
    ObjectsTXKmKonto: TIntegerField;
    ObjectsTTimKonto: TIntegerField;
    ObjectsTVStat: TFloatField;
    CustomerTCust_Id: TIntegerField;
    CustomerTName: TWideStringField;
    CustomerTContact: TWideStringField;
    CustomerTCo_Adr: TWideStringField;
    CustomerTAdress: TWideStringField;
    CustomerTPostal_Name: TWideStringField;
    CustomerTCountry: TWideStringField;
    CustomerTOrg_No: TWideStringField;
    CustomerTTel_1: TWideStringField;
    CustomerTTel_Nr_1: TWideStringField;
    CustomerTTel_2: TWideStringField;
    CustomerTTel_Nr_2: TWideStringField;
    CustomerTTel_3: TWideStringField;
    CustomerTTel_Nr_3: TWideStringField;
    CustomerTUtlandsk: TBooleanField;
    CustomerTKTyp: TWideStringField;
    CustomerTKontoNr: TWideStringField;
    CustomerTKExp: TWideStringField;
    CustomerTPtyp: TWideStringField;
    CustomerTNot: TMemoField;
    CustomerTPayment: TWideStringField;
    CustomerTTerms_Pay: TSmallintField;
    CustomerTKundFdrKonto: TIntegerField;
    CustomerTIKonto: TIntegerField;
    CustomerTIKStalle: TIntegerField;
    CustomerTSamlingsFaktura: TBooleanField;
    CustomerTInt_Cust: TBooleanField;
    CustomerTIns_Comp: TBooleanField;
    CustomerTDelfaktureras: TBooleanField;
    ...
    CustomerTDriver: TBooleanField;
    ObjectsTLDatum: TDateField;
    ObjectsTLKM: TSmallintField;
    Q2Cust: TADOQuery;
    Q3PKlass: TADOQuery;
    ObjectsTLkmStart: TIntegerField;
...
//    Speedbutton3: TTransparentButton2;
    ...
    PaKundG: TPanel;
    DBGrid1: TDBGrid;
    CustomerTCust_Koncern: TBooleanField;
    BtnTotRecNo: TEdit;
    BtnRecNo: TEdit;
    procedure AddKund;
...
begin
  i := 0;
  if MessageDlg('Vill du rensa kundposter?',
