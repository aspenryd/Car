...
{**********************************************************************}
{}
{ $Log:  13542: Delbet.pas
{
{   Rev 1.1    2004-01-29 10:26:34  peter
...
var
  ...
  fors: boolean;
begin
  frmSearch.GSQLString := 'Select Customer.name, Customer.Adress, Customer.Postal_name, Customer.Tel_nr_1, Customer.Org_no, Customer.Payment, Customer.Terms_pay, Customer.Ins_comp from Customer Where Cust_id = ' + cuid;
...
begin
  if Edit3.Text > '!' then
  try
    Edit3.Text := DateToStr(StrToDate(Edit3.Text));
  except
    Edit3.SetFocus;
    raise;
  end;
