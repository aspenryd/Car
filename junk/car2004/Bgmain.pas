...
//! Benny Testar  frmSearch.GSQLString := 'SELECT Objects.Reg_No, Objects.ObjNum, Objects.Model, Objects.Type, Objects.KM_N, Objects.DType, Objects.Color, Objects.Accesories FROM Objects Order by Objects.Reg_No';
  ...
  begin
    ...
    begin
      ...
      Hinttext := Hinttext + ' Färg : ' + frmSearch.GSearchCDS.FieldByName('Color').AsString + #13;
      Hinttext := Hinttext + ' Tillbehör : ' + frmSearch.GSearchCDS.FieldByName('Accesories').AsString + #13;
      Hinttext := Hinttext + ' Drivmedel : ' + frmSearch.GSearchCDS.FieldByName('DType').AsString + #13;
      Hinttext := Hinttext + ' Mätarställning : ' + frmSearch.GSearchCDS.FieldByName('KM_N').AsString;
...
//!Ändrat i SQL frågan för att inte ta med alla gamla kontrakt...
