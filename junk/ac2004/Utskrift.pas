...
begin
  ...
  begin
    ADOQuery1.SQL.Clear;
    ADOQuery1.SQL.Add('SELECT e_faktnr FROM fakthead WHERE utskrdat = ''' + DateToStr(DTP1.Date) + ''' AND Payment = ''F'' ORDER BY FAKTNR');
    ADOQuery1.Open;
  ...
  begin
    ADOQuery1.SQL.Clear;
    ADOQuery1.SQL.Add('SELECT e_faktnr FROM fakthead WHERE utskrdat = ''' + DateToStr(DTP1.Date) + ''' AND Payment = ''I'' ORDER BY FAKTNR');
    ADOQuery1.Open;
    while not ADOQuery1.Eof do begin
      try
        PrintOutReport('kvitto_sf.ini', ADOQuery1.FieldByName('e_faktnr').AsString + ';', DMod2.ParamT.FieldByName('FAKTURA_COPY').AsInteger, CbGranska.Checked);
  ...
  begin
    ADOQuery1.SQL.Clear;
    ADOQuery1.SQL.Add('SELECT e_faktnr FROM fakthead WHERE utskrdat = ''' + DateToStr(DTP1.Date) + ''' AND Payment = ''K'' ORDER BY FAKTNR');
    ADOQuery1.Open;
    while not ADOQuery1.Eof do begin
      try
        PrintOutReport('kvitto_sf.ini', ADOQuery1.FieldByName('e_faktnr').AsString + ';', DMod2.ParamT.FieldByName('FAKTURA_COPY').AsInteger, CbGranska.Checked);
  ...
  begin
    ADOQuery1.SQL.Clear;
    ADOQuery1.SQL.Add('SELECT e_faktnr FROM fakthead WHERE utskrdat = ''' + DateToStr(DTP1.Date) + ''' AND Payment = ''O'' ORDER BY FAKTNR');
    ADOQuery1.Open;
    while not ADOQuery1.Eof do begin
      try
        PrintOutReport('kvitto_sf.ini', ADOQuery1.FieldByName('e_faktnr').AsString + ';', DMod2.ParamT.FieldByName('FAKTURA_COPY').AsInteger, CbGranska.Checked);
